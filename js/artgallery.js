...
const drawings = [
  { src: "img/art/cali.png", alt: "Cali" },
  { src: "img/art/biscuit.png", alt: "Biscuit" },
...
const photos = [
  ...
  { src: "img/artphotos/colosseum.jpg", alt: "Colosseum" },
   { src: "img/artphotos/mejiro.jpg", alt: "Mejiro" },
   ...
   { src: "img/artphotos/roppongichristmas.jpg", alt: "Roppongi Christmas" },
  ...
  { src: "img/artphotos/namiueshrine.jpg", alt: "Namiue Shrine" },
  { src: "img/artphotos/reykjavikaurora.jpg", alt: "Reykjavik Aurora" },
  { src: "img/artphotos/ferrysunset.jpg", alt: "Ferry Sunset" },
  { src: "img/artphotos/icelandice.jpg", alt: "Iceland Ice" },
  { src: "img/artphotos/umikajiterrace.jpg", alt: "Umikaji Terrace" },
 ...
 { src: "img/artphotos/nachifalls.jpg", alt: "Nachi Falls" },
 { src: "img/artphotos/hashiguiiwa.jpg", alt: "Hashiguiiwa" },
 { src: "img/artphotos/tsutenkaku.jpg", alt: "Tsutenkaku" },
 { src: "img/artphotos/aoiike.jpg", alt: "Aoiike" },
 { src: "img/artphotos/chestnuttigerbutterfly.jpg", alt: "Chestnut Tiger Butterfly" },
  { src: "img/artphotos/bloodmoon.jpg", alt: "Blood Moon" },
  { src: "img/artphotos/amanohashidate.jpg", alt: "Amanohashidate" },
  ...
  { src: "img/artphotos/okinawamoon.jpg", alt: "Okinawa Moon" },
